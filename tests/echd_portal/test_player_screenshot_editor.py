...
class TestPlayerScreenshotEditor(TestCase):
    ...
    def test_5_player_screenshot_assert_edit_button(self):
    ...
    def test_6_player_screenshot_edit__head(self):
    ...
    def test_7_player_screenshot_edit_change_form_size(self):
    ...
    def test_8_player_screenshot_edit_change_form_size_restore(self):
        el["Кнопка изменения размера формы создания скриншотов"].assert_element_interaction()
        el["Кнопка изменения размера формы создания скриншотов"].click()

    @title("Проверяем наличие инструмента редактирования скриншота: Выбор цвета")
    def test_9_player_screenshot_edit_color_change(self):
    ...
    def test_10_player_screenshot_edit_redo(self):
    ...
    def test_11_player_screenshot_edit_undo(self):
    ...
    def test_12_player_screenshot_edit_font_size(self):
    ...
    def test_13_player_screenshot_edit_line_size(self):
    ...
    def test_14_player_screenshot_edit_text_add(self):
    ...
    def test_15_player_screenshot_edit_arrow_add(self):
    ...
    def test_16_player_screenshot_edit_line_add(self):
    ...
    def test_17_player_screenshot_edit_circle_add(self):
    ...
    def test_21_player_screenshot_edit_form_close(self):
